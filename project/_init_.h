...
#include "_file_system_.h"
  ...
  /// @param      string 
  /// @param      outputBuffer 
  extern  void    sha256_hash_string(const char *string, char outputBuffer[65]);
  ...
  /// @param      str 
  /// @return 
  extern  _ui8    _str_copy(char *arr1, const char *str);
  ...
  /// @param      str 
  /// @return 
  extern  _ui8    _str_cat(char *arr1, _ui32 size_arr1, const char *str);
